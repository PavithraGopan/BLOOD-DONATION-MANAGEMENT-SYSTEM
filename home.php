  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="_107317099_blooddonor976.jpg"  width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="Blood-facts_10-illustration-graphics__canteen.png" width="100%" height="500">
      </div>
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="blood_donationcover.jpeg" alt="" >
            </div>
        </div>
        <!-- /.row -->
